    ...
    public static function schema(): array
    {
        return [
            Infolists\Components\TextEntry::make('tenant')
                ->label(__('filament-approval::model.approval_task.tenant'))
                ->inlineLabel()
            ...
            Infolists\Components\TextEntry::make('ip_address')
                ->label(__('filament-approval::model.approval_task.ip_address'))
                ->inlineLabel()
                ->visible(static fn(?string $state): bool => filled($state)),
            Infolists\Components\TextEntry::make('os')
                ->label(__('filament-approval::model.approval_task.os'))
                ->inlineLabel(),
        ];
    }
}
